...
public class AdvancedWebView extends WebView {
    ...
    public interface Listener {
        ...
        void onDownloadRequested(String url, String mimetype, long contentLength, String contentDisposition, String userAgent);
    ...
    public void setWebChromeClient(final WebChromeClient client) {
        Log.e("AdvancedWebView", "You should not call setWebChromeClient(client) directly.");
    }

    @Override
    public void setWebViewClient(final WebViewClient client) {
        Log.e("AdvancedWebView", "You should not call setWebViewClient(client) directly.");
    }


    public void setCustomWebViewClient(final WebViewClient client) {
        mCustomWebViewClient = client;
    }


    public void setCustomWebChromeClient(final WebChromeClient client) {
        mCustomWebChromeClient = client;
    }


    public void setDefaultWebViewClient(final WebViewClient client) {
        super.setWebViewClient(client);
    }

    public void setDefaultWebChromeClient(final WebChromeClient client) {
...
//    }
    ...
    public class AWebViewClient extends WebViewClientCompat {
        ...
        public boolean checkByURL(final WebView view, final String url){
...
//                    externalSchemeIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
                    return true;
    ...
    public class ADownloadListener implements DownloadListener {


        @Override
        public void onDownloadStart(final String url, final String userAgent, final String contentDisposition, final String mimetype, final long contentLength) {
//            AdvancedWebView.this.onDownloadStart(url, userAgent, contentDisposition, mimetype, contentLength);
...
//            final String suggestedFilename = URLUtil.guessFileName(url, contentDisposition, mimeType);
            ...
            if (mListener != null) {
                mListener.onDownloadRequested(url, mimetype, contentLength, contentDisposition, userAgent);
            }
        }
...
//        super.setWebViewClient(new AWebViewClient());

//        super.setWebChromeClient(new AWebChromeViewClient());

//        setDownloadListener(new ADownloadListener());
    }
